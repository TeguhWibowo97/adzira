<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-book-reader"> </i> Edit Absensi</h1>
          </div>
        </div><!-- /.row  -->
      </div><!-- /.container-fluid  -->
    </div>
        ...
        <div class="container">
            <div class="alert alert-warning" role="alert">
                <?php foreach($tentor as $t):?> 
                    <?php if($absensi['id_tentor'] == $t['id_tentor']) :?> 
                        Nama Tentor adalah <strong><?= $t['nama'];?> </strong>
                    <?php endif;?>             
                <?php endforeach;?>
            </div>
            <div class="card">
            ...
            <form action="<?= base_url();?>c_absensi/ubah/<?= $absensi['id_absensi'];?>" method="post">
                <div class="card-body">
                    <div class="form-group">
                        <label class="col-form-label">Nama Siswa</label>
                        <select name="id_siswa" class="custom-select">
                            <?php foreach($siswa as $s):?>
                                <?php if($absensi['id_siswa'] == $s['id_siswa']) :?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" value="<?= $absensi['tanggal'];?>" name="tanggal">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Hari</label>
                        <select name="hari" class="custom-select">
                            <?php foreach($hari as $h):?>
                                <?php if($absensi['hari'] == $h) :?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $absensi['mapel'];?>" name="mapel">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Jam</label>
                        <input type="time" class="form-control" value="<?= $absensi['jam'];?>" name="jam">
                    </div>
                    <div class="form-group float-right mt-5">
                        <a href="<?= base_url();?>c_absensi/detail/<?= $absensi['id_absensi'];?>" class="btn btn-secondary">Kembali</a>
